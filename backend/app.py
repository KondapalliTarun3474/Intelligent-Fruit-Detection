...
# Load the categories
categories = os.listdir(r"C:\Users\K.S.TARUN\OneDrive\Desktop\swaroop_newborn\backend\dataset3\test")
categories.sort()
...
def detect_fruit(frame):
    ...
    input_text = "From the given image detect and give me only the fruit names present in the input image, if no fruit is there give no fruit present, dont give any infromation in gemini"
    ...
    input_text = "From the given input image find what are the classes of fruits resent and for each class,  give total number of fruits belonging to that class"
...
0# Function to record and recognize speech
